...
* 📊 **Monitoring & Security:** Zabbix, PRTG Network Monitor, Wazuh SIEM/XDR, Kali Linux for security auditing & penetration testing.
* 🐧 **Linux Systems & Cloud:** Service management (systemd, up-services), deployment & administration (Linux Mint, Ubuntu Desktop/Server/Core, Debian), Nextcloud self-hosted services.
* 🪟 **Windows Systems:** Active Directory Domain Services (AD DS), Group Policy (GPO), Windows Server Administration.
* ☁️ **Virtualization & Infra:** VMware (ESXi/vSphere), Microsoft Hyper-V, Docker containers.
* 🐍 **Automation & Scripting:** Python for network automation & custom tooling, Bash, PowerShell.
* 📜 **Certifications:** Cisco CCNA
* 🎓 **Education:** BSc Informatics @ Hellenic Open University
...
![IPFire](https://img.shields.io/badge/IPFire-000000?style=for-the-badge&logo=linux&logoColor=white)
![TP-Link](https://img.shields.io/badge/TP--Link-00A3E0?style=for-the-badge&logo=tp-link&logoColor=white)
...
#### Monitoring, SIEM & Security
![Zabbix](https://img.shields.io/badge/Zabbix-F11B2C?style=for-the-badge&logo=zabbix&logoColor=white)
![PRTG](https://img.shields.io/badge/PRTG_Monitor-008080?style=for-the-badge&logo=paessler&logoColor=white)
![Wazuh](https://img.shields.io/badge/Wazuh_SIEM-00A3E0?style=for-the-badge&logo=wazuh&logoColor=white)
![Kali Linux](https://img.shields.io/badge/Kali_Linux-557C93?style=for-the-badge&logo=kali-linux&logoColor=white)

#### Systems, Cloud & Operating Systems
...
![VMware](https://img.shields.io/badge/VMware-607274?style=for-the-badge&logo=vmware&logoColor=white)
![Hyper-V](https://img.shields.io/badge/Microsoft_Hyper--V-0078D4?style=for-the-badge&logo=windows&logoColor=white)
